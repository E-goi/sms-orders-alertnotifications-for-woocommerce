							...
							<form action="#" method="post" class="form-sms-order-config" id="form-sms-order-senders">
								...
								<select class="e-goi-option-select-admin-forms" style="width: 100%;" name="sender_hash" id="sender_hash" required>
									...
									if ( isset( $senders ) && count( $senders ) > 0 ) {
										foreach ( $senders as $sender ) {
											?>
											<option value="<?php echo $sender['FROMID']; ?>" <?php selected( $sender['FROMID'], $sender_option['sender_hash'] ); ?> >
												<?php echo $sender['SENDER']; ?>
											</option>
											<?php
										}
									}
								...
								<select name="admin_prefix" class="e-goi-option-select-admin-forms" style="width: 49%; float: left;" required >
									...
									foreach ( unserialize( EFWP_COUNTRY_CODES ) as $key => $value ) {
										...
										?>
										<option value="<?php echo $value['prefix']; ?>" <?php selected( $value['prefix'], $sender_option['admin_prefix'] ); ?> ><?php echo $string; ?></option>
										<?php
									}
									?>
								</select>
								...
								<table border='0' class="widefat striped" style="width: 100%;">
									...
									<?php foreach ( $this->helper->smsonw_get_order_statuses() as $cod => $name ) { ?>
										<tr>
											<td><?php echo $name; ?></td>
											<td align="center">
												<input class="input-checkbox" type="checkbox" name="egoi_sms_order_customer_<?php echo $cod; ?>" value="1"
													<?php checked( $recipients[ 'egoi_sms_order_customer_' . $cod ], 1 ); ?>
												/>
											</td>
											<td align="center">
												<input class="input-checkbox admin-order-status" type="checkbox" name="egoi_sms_order_admin_<?php echo $cod; ?>" value="1"
								...
								<select name="egoi_reminders_time" id="egoi_reminders_time" class="e-goi-option-select-admin-forms" style="width: 49%;">
									...
									<?php foreach ( $reminder_times as $value ) { ?>
										<option value="<?php echo $value; ?>" <?php selected( $value, $recipients['egoi_reminders_time'] ); ?>><?php echo $value; ?>h</option>
									<?php } ?>
								</select>
								...
								<select name="egoi_email_reminders_time" id="egoi_email_reminders_time" class="e-goi-option-select-admin-forms" style="width: 49%;">
									...
									<?php foreach ( $reminder_times as $value ) { ?>
										<option value="<?php echo $value; ?>" <?php selected( $value, $recipients['egoi_email_reminders_time'] ); ?>><?php echo $value; ?>h</option>
									<?php } ?>
								</select>
						...
						<td valign="top">
							<div id="egoi-account-info" style="background-color: #ffffff; padding: 1px 20px 15px 20px; border: 1px solid #dddddd">
								...
								<p class="label_text_mini">
									...
									<span style="background-color: #00aeda; color: white; padding: 5px; border-radius: 2px; margin-left: 5px; font-size: 14px;"><?php echo $balance; ?></span>
								</p>
							</div>
							<div id="test-sms">
				...
				<form action="#" method="post" class="form-sms-order-config" id="form-sms-order-texts">
					...
					<div id="sms_texts_select_lang">
						<select class="e-goi-option-select-admin-forms" style="width: 400px;" name="sms_text_language" id="sms_text_language">
							...
							<?php foreach ( $this->helper->smsonw_get_languages() as $code => $language ) { ?>
								<option value="<?php echo $code; ?>" <?php selected( $_POST['sms_text_language'], $code ); ?>>
									<?php echo $language; ?>
								</option>
							<?php } ?>
						</select>
					...
					<div id="sms_texts_tags">
						...
						<?php foreach ( $this->helper->sms_text_tags as $tag_name => $tag_cod ) { ?>
							<button type="button" class="button button-default sms_texts_tags_button" data-text-cod="<?php echo $tag_cod; ?>">
					...
					<?php foreach ( $this->helper->smsonw_get_languages() as $code => $lang ) { ?>
						<div id="sms_order_texts_<?php echo $code; ?>">
								...
								<?php foreach ( $this->helper->smsonw_get_order_statuses() as $cod => $name ) { ?>
									<tr>
										...
										<td>
											...
											?>
											<textarea name="egoi_sms_order_text_customer_<?php echo $cod; ?>" cols="40" rows="4" id="egoi_sms_order_text_customer_<?php echo $cod; ?>"><?php echo $text; ?></textarea>
										</td>
										<td>
											<textarea name="egoi_sms_order_text_admin_<?php echo $cod; ?>" cols="40" rows="4" id="egoi_sms_order_text_admin_<?php echo $cod; ?>"><?php echo $texts[ $code ][ 'egoi_sms_order_text_admin_' . $cod ]; ?></textarea>
										</td>
									</tr>
								<?php } ?>
								</tbody>
		...
		<div class="row">
			...
			<div class="main-content col col-12" style="margin:0 0 20px;">
				...
				<form action="#" method="post" class="form-sms-order-config" id="form-sms-order-payment-texts">
					...
					<div id="sms_select_payment_method">
						<select class="e-goi-option-select-admin-forms" style="width: 400px;" name="sms_payment_method" id="sms_payment_method">
							...
							<?php foreach ( $this->helper->smsonw_get_payment_methods() as $code => $method ) { ?>
								<option value="<?php echo $code; ?>" <?php selected( $_POST['sms_payment_method'], $code ); ?>>
									<?php echo $method; ?>
								</option>
							<?php } ?>
						</select>
					...
					<div id="sms_order_payment_texts_<?php echo $method_code; ?>">
						<table border="0" class="widefat striped" style="max-width: 900px;">
							<thead>
							<tr>
							...
							<?php foreach ( $this->helper->smsonw_get_languages() as $lang_code => $lang ) { ?>
								<tr>
									...
									<td>
										...
										?>
										<textarea name="egoi_sms_order_payment_text_<?php echo $lang_code; ?>" cols="40" rows="4" id="egoi_sms_order_payment_text_<?php echo $lang_code; ?>"><?php echo $text; ?></textarea>
									</td>
									<td>
										<?php
										$text = '';
										...
										?>
										<textarea name="egoi_sms_order_reminder_text_<?php echo $lang_code; ?>" cols="40" rows="4" id="egoi_sms_order_reminder_text_<?php echo $lang_code; ?>"><?php echo $text; ?></textarea>
									</td>
								</tr>
							<?php } ?>
							</tbody>
		...
		<div class="row">
			...
			<div class="main-content col col-12" style="margin:0 0 20px;">
				...
				<form action="#" method="post" class="form-sms-order-config" id="form-email-order-payment-texts">
					...
					<div id="email_order_payment_texts_<?php echo $method_code_email; ?>">
						<table border="0" class="widefat striped" style="max-width: 900px;">
							<thead>
							<tr>
								<th><?php _e( 'Language', 'smart-marketing-addon-sms-order' ); ?></th>
							...
							<?php foreach ( $this->helper->smsonw_get_languages() as $lang_code_email => $lang ) { ?>
								<tr>
									...
									<td>
										...
										?>
										<textarea name="egoi_sms_order_reminder_email_text_<?php echo $lang_code_email; ?>" cols="40" rows="8" id="egoi_sms_order_reminder_email_text_<?php echo $lang_code_email; ?>" style="width: 720px;"><?php echo $text; ?></textarea>
									</td>
								</tr>
							<?php } ?>
							</tbody>
									...
									<div>
										<div class="smsnf-input-group">
											...
											<div class="colorpicker-wrapper">
												...
												<p><?php echo _e( 'Select Color', 'egoi_sms_follow_price_enable_title' ); ?></p>
											</div>
										</div>
									</div>
								</td>
					...
					<div id="sms_order_tracking_urls">
						<table border="0" class="widefat striped" style="max-width: 900px;">
							...
							<?php foreach ( $this->helper->smsonw_get_tracking_carriers() as $tracking_code_name => $tracking_name ) { ?>
								<tr>
									<td><span><?php echo $tracking_name; ?></span></td>
									<td>
										<input name="<?php echo $tracking_code_name; ?>" id="egoi_sms_order_tracking_<?php echo $tracking_code_name; ?>" style="min-width: 400px;width: 100%;" value="<?php echo isset( $urls[ $tracking_code_name ] ) ? $urls[ $tracking_code_name ] : ''; ?>"/>
									</td>
								</tr>
							<?php } ?>
							</tbody>
